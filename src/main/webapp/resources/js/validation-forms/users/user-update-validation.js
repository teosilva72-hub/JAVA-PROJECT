...
$(function () {
    ...
    validateUserForm('#form-update', validatorMinLengthMsg, validatorMaxLengthMsg, fullNameMsg, jobPositionMsg,
    ...
    //click reset button action
    resetFormValidation("#form-update", "reset-btn");
...
function redirecToSearch() {
    window.setTimeout(
        function() {									
            window.location.href = "panel_user.xhtml?faces-redirect=true";
  }, 5000);
};
