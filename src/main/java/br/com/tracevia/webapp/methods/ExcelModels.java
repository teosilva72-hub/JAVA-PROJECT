...
public class ExcelModels {
	...
	public void periodFlowStyles() {
		...
		standardStyle1.setFillBackgroundColor(IndexedColors.WHITE.getIndex()); // Cor na sele��o da c�lula
	...
	public void StandardEquipExcelModel(String[] columnsHeader, int registers, String[] name, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		if(period.equals("24 hours")) {
			...
			spreadSheet.fillDataEquipSingle(sheet, row, cellData, resultQuery, period, startColumn, length, ini, registerLength); // Preencher a colunas

			spreadSheet.createCells(sheet, row, 0, length, rowMax, rowMax);			 
			spreadSheet.getCell(sheet, row, rowMax, 0, localeExcel.getStringKey("excel_report_excel_total"));

			spreadSheet.totalExcelEquip(sheet, row, period, totalStartColumn, length, rowIni, rowMax);	   

			spreadSheet.setStyle(sheet, row, ini, rowMax, dateHourStyle, 0, 2); 
			spreadSheet.setStyle(sheet, row, rowMax, rowMax, tableHeaderStyle, 0, 0);
			spreadSheet.setStyle(sheet, row, ini, rowMax, standardStyle, cellMinCol, cellMaxCol);	    
	...
	public void ExcelModelEquipDirections(String[] columnsHeader, int registers, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		if(period.equals("24 hours")) {
			...
			spreadSheet.fillDataEquipSingleDirections(sheet, row, cellData, resultQuery, period, startColumn, length, ini, registerLength, 1); // Preencher a colunas

			spreadSheet.createCells(sheet, row, 0, length, rowMax, rowMax);			 
			spreadSheet.getCell(sheet, row, rowMax, 0, localeExcel.getStringKey("excel_report_excel_total"));

		    spreadSheet.totalExcelEquip(sheet, row, period, startColumn, length, ini, rowMax);	
			...
			spreadSheet.fillDataEquipSingleDirectionsDir1(sheet, row, cellData, resultQuery, period, startColumn, length, rowDataDir1, registerLength, iniDir1); // Preencher a colunas
			...
			spreadSheet.totalExcelEquip(sheet, row, period, startColumn, length, rowDataDir1, rowMaxDir1);	 
						
			spreadSheet.setStyle(sheet, row, rowDataDir1, rowMaxDir1, dateHourStyle, 0, 2);	
			...
			spreadSheet.fillDataEquipSingleDirectionsDir2(sheet, row, cellData, resultQuery, period, startColumn, length, rowDataDir2, registerLength, iniDir2); // Preencher a colunas
			...
			spreadSheet.totalExcelEquip(sheet, row, period, startColumn, length, rowDataDir2, rowMaxDir2);	   

			spreadSheet.setStyle(sheet, row, rowDataDir2, rowMaxDir2, dateHourStyle, 0, 2);	
			...
			for(int d = 0; d < daysCount; d++) {
				...
				spreadSheet.fillDataEquipRangeDirections(sheet, row, cellData, resultQuery, period, startColumn, length, ini, registerLength, d, range, 1); // Preencher a colunas
				...
				spreadSheet.fillDataEquipRangeDirectionsDir1(sheet, row, cellData, resultQuery, period, startColumn, length, rowDataDir1, registerLength, d, range, iniDir1); // Preencher a colunas
				...
				spreadSheet.fillDataEquipRangeDirectionsDir2(sheet, row, cellData, resultQuery, period, startColumn, length, rowDataDir2, registerLength, d, range, iniDir2); // Preencher a colunas
	...
	public void StandardExcelModelWithoutTotal(String[] columnsHeader, int registers, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		if(period.equals("24 hours") || period.equals("month") || period.equals("year")) {
			...
			spreadSheet.createRows(sheet, row, ini, rowMax); // Criar o n�mero de linhas
    ...
    //USED MTO
	//////////////////
	public void StandardExcelModelWithoutTotalMTO(String[] columnsHeader, int registers, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
			String fileTitle, String equip, String city, String road, String km, String mtoType, String startDate, String endDate, String[] mergeCells, int[] columnsWidth, int colStartDate, int colEndDate, String[][] resultQuery ) throws Exception {
		...
		if(period.equals("24 hours") || period.equals("month") || period.equals("year")) {
			...
			spreadSheet.createRow(sheet, row, 9);	
			spreadSheet.createCell(sheet, row, 9, 1, localeExcel.getStringKey("excel_report_consultation_type"));
			spreadSheet.createCell(sheet, row, 9, 2, mtoType);
	...
	public void ExcelModelDirectionsSubHeader(String[] columnsHeader, int registers, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		if(period.equals("24 hours")) {
			...
			spreadSheet.createCells(sheet, row, 2, 19, 11, 11);
			spreadSheet.getCell(sheet, row, 11, 2, localeSat.getStringKey("sat_reports_header_lights"));
			spreadSheet.getCell(sheet, row, 11, 6, localeSat.getStringKey("sat_reports_header_trucks"));
			spreadSheet.getCell(sheet, row, 11, 15, localeSat.getStringKey("sat_reports_header_buses"));

			spreadSheet.setCellStyle(sheet, row, standardStyle, 2, 19, 11, 11);
			...
			spreadSheet.getCell(sheet, row, headerPos1, 15, localeSat.getStringKey("sat_reports_header_buses"));

			spreadSheet.setCellStyle(sheet, row, standardStyle, 2, 19, headerPos1, headerPos1);
			...
			spreadSheet.createCells(sheet, row, 2, 19, headerPos2, headerPos2);
			spreadSheet.getCell(sheet, row, headerPos2, 2, localeSat.getStringKey("sat_reports_header_lights"));
			spreadSheet.getCell(sheet, row, headerPos2, 6, localeSat.getStringKey("sat_reports_header_trucks"));
			spreadSheet.getCell(sheet, row, headerPos2, 15, localeSat.getStringKey("sat_reports_header_buses"));

			spreadSheet.setCellStyle(sheet, row, standardStyle, 2, 19, headerPos2, headerPos2);
	...
	public void ExcelModelPeriodFlow(int fieldsNumber, int registers, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		//ROW				
		spreadSheet.createRows(sheet, row, 0, 4); // Criar o n�mero de linhas
	...
	public void ExcelModelMonthlyFlow(int fieldsNumber, int registers, int daysInMonth, int range, int daysCount, String period, String currentDate, String type, String module, String logo, 
		...
		spreadSheet.createRows(sheet, row, 1, 2); // Criar o n�mero de linhas
	...
	// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		public void StandardEquipSOSExcelModel(String[] columnsHeader, int registers, String[] name, int range, int daysCount, String period, String currentDate, String module, String logo, 
				String fileTitle, String sheetName, List<SOS> sosList, String startDate, String endDate, String[] mergeCells, int[] columnsWidth, int colStartDate, int colEndDate, String[][] resultQuery ) throws Exception {
			...
			if(period.equals("24 hours")) {
				...
				spreadSheet.fillDataEquipSingleSOSAmount(sheet, row, cellData, resultQuery, period, startColumn, length, ini, registerLength); // Preencher a colunas

				spreadSheet.createCells(sheet, row, 0, length, rowMax, rowMax);			 
				spreadSheet.getCell(sheet, row, rowMax, 0, localeExcel.getStringKey("excel_report_excel_total"));

				spreadSheet.totalExcelEquip(sheet, row, period, totalStartColumn, (length-1), rowIni, rowMax);						
				spreadSheet.totalExcelDateFormat(workbook, sheet, row, 8, rowIni, rowMax);	
				...
				for(int d = 0; d < name.length; d++) {
					...
					spreadSheet.createRow(sheet, row, 5);
					spreadSheet.createCell(sheet, row, 5, 0, localeExcel.getStringKey("excel_report_consultation_equipment"));
					spreadSheet.createCell(sheet, row, 5, 2, sosList.get(d).getNome());
					spreadSheet.createCell(sheet, row, 5, 5, localeExcel.getStringKey("excel_report_consultation_date"));
					spreadSheet.createCell(sheet, row, 5, 8, " " + currentDate);
					...
					spreadSheet.createRow(sheet, row, 6);	
					spreadSheet.createCell(sheet, row, 6, 1, localeExcel.getStringKey("excel_report_consultation_city"));
					spreadSheet.createCell(sheet, row, 6, 2, sosList.get(d).getCidade() );
					spreadSheet.createCell(sheet, row, 6, 7, localeExcel.getStringKey("excel_report_consultation_direction"));
					spreadSheet.createCell(sheet, row, 6, 8, localeDirections.getStringKey("directions_all") );
					...
					spreadSheet.createRow(sheet, row, 7);	
					spreadSheet.createCell(sheet, row, 7, 1, localeExcel.getStringKey("excel_report_consultation_highway"));
					spreadSheet.createCell(sheet, row, 7, 2, sosList.get(d).getEstrada() );
					spreadSheet.createCell(sheet, row, 7, 7, localeExcel.getStringKey("excel_report_consultation_period"));
					spreadSheet.createCell(sheet, row, 7, 8, tm.periodName(period));
					...
					spreadSheet.createRow(sheet, row, 8);	
					spreadSheet.createCell(sheet, row, 8, 1, localeExcel.getStringKey("excel_report_consultation_km"));
					spreadSheet.createCell(sheet, row, 8, 2, sosList.get(d).getKm() );
					...
					spreadSheet.fillDataEquipRangeSOSAmount(sheet, row, cellData, resultQuery, period, startColumn, length, ini, registerLength, d, sheetRows); // Preencher a colunas
