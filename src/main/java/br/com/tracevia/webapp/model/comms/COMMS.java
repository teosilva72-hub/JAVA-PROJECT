...
public class COMMS extends Equipments {
	...
	public COMMS(int equip_id, String table_id, String equip_type, String equip_ip, String creation_date,
			...
			int height, int linearWidth, int dlgPosX, int dlgPosY, int status, String direction, int lastStatus, boolean notificacao,
			boolean visible) {
