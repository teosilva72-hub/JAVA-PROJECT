...
public class LoadStartupModules {  
	...
	/**
	  * Mï¿½todo inicializar componentes de visualizaï¿½ï¿½o
	 * @throws Exception
	 */
	...
	/**
	 * Mï¿½todo para retornar lista de mï¿½dulos ativos 
	 * @throws Exception
	 */
	...
	/**
	 * Mï¿½todo para retornar lista de equipmentos para cada modulo
	 * @throws Exception
	 */		
