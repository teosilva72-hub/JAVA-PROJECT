...
public class DMS extends Equipments {
	...
	public DMS(int equip_id, String table_id, String equip_type, String equip_ip, String creation_date,
			...
			int lastStatus, boolean notificacao, int port, boolean visible, int leds, int dms_type, String dmsType_name,
			String dms_ip, Messages message, Messages messageChange, boolean stat, boolean msg_status) {
