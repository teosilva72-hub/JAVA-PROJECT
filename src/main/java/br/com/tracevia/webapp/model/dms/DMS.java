...
public class DMS extends Equipments {
	...
	public DMS(int equip_id, String table_id, String equip_type, String creation_date, String creation_username,
			...
			int dlgPosX, int dlgPosY, int status, int last_status, boolean notificacao, boolean visible, int leds,
			int dms_type, String dmsType_name, String dms_ip, Messages message, Messages messageChange, boolean stat,
			boolean msg_status) {
