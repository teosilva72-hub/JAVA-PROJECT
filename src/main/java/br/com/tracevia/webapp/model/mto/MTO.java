...
public class MTO extends Equipments{
	...
	public MTO(int equip_id, String table_id, String creation_date, String creation_username, String update_date,
			...
			int dlgPosX, int dlgPosY, int status, boolean notificacao, boolean visible, String data_hora, String data,
			String intervalos, int monthOrDay, int press_atmosferica, int umi_relativa, int taxa_precipitacao,
			int taxa_precipitacao1h, int velocidadeMed_vento, int direcao_vento, int temp_ar, int visibilidade,
