package br.com.tracevia.webapp.model.lpr;

import br.com.tracevia.webapp.model.global.Equipments;

public class LPR extends Equipments {
	...
	public LPR(int equip_id, String table_id, String creation_date, String creation_username, String nome, String estrada,
		...
		super(equip_id, table_id, creation_date, creation_username, nome, estrada, cidade, km, posicao, linearPosX, linearPosY,
				mapPosX, mapPosY, width, height, dlgPosX, dlgPosY, status, notificacao, visible);
