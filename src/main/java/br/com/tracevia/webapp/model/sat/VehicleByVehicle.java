...
public class VehicleByVehicle {
	...
	public VehicleByVehicle(int vbv_id, int siteID, int seqG, int seqN, int axlNumber, int gross, int picDiff,
		int speed, int lane, int deltaD1, int deltaT1, int axlT1, int deltaD2, int deltaT2, int axlT2,
		int temperature, int axl1w, int axl2w, int axl3w, int axl4w, int axl5w, int axl6w, int axl7w, int axl8w,
		int axl9w, int axl10w, int axl2d, int axl3d, int axl4d, int axl5d, int axl6d, int axl7d, int axl8d,
		int axl9d, int axl10d, String dateTime, String date, String interval, String classDnit, String classVBV,
		String plate, String name) {
