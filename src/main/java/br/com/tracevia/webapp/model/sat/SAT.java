...
public class SAT extends Equipments {
	...
	public SAT(int equip_id, String table_id, String equip_type, String equip_ip, String creation_date,
			...
			int velocidadeS2, int statusInterval, String faixa1, String faixa2, String faixa3, String faixa4,
			String faixa5, String faixa6, String faixa7, String faixa8, String qtdeFaixas, String sentidos,
			String sentido1, String sentido2, String sentido1Abbr, String sentido2Abbr, String posicao_nivel_servico,
			String dataTime) {
