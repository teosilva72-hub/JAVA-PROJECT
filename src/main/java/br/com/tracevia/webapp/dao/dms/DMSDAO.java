...
public class DMSDAO {
	...
	public ArrayList<DMS> idsDMS() throws Exception {
		...
		String sql = "SELECT equip_id, ip_equip, name, km, linear_width, linear_posX, linear_posY, map_width, map_posX, map_posY, id_message, id_modify, driver, active FROM pmv_equipment pmv INNER JOIN pmv_messages_active act WHERE act.id_equip = pmv.equip_id AND visible = 1 ORDER BY pmv.equip_id ASC";
