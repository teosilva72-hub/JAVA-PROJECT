...
public class PMVmessageBean implements Serializable {
 ...
 public void createAvailableMessage() throws Exception {
	...
	//Pegar Usu�rio na sess�o 
	 ...
	 else message.ErrorMessage(localeMessage.getStringKey("dms_available_message_register_error"), " ");
  }
  ...
  public void updateAvailableMessage() throws Exception {
	 ...
	 else message.InfoMessage(localeMessage.getStringKey("dms_available_message_update_error"), " ");
  ...
  public void deleteRegister() throws Exception {
	 ...
	 else message.InfoMessage(localeMessage.getStringKey("dms_available_message_delete_error"), " " );  
	 
	 } else message.ErrorMessage(localeMessage.getStringKey("dms_available_message_delete_error_in_use_header"), localeMessage.getStringKey("dms_available_message_delete_error_in_use_body")); 
	 	 
	 } else  message.WarningMessage(localeMessage.getStringKey("dms_activation_message_activation_not_found"), " "); 
 ...
 public List<Messages> getActivesMessages() throws Exception  {
	...
	// messageActive = msg.getTexto();
	 ...
	 //int value = initCharsFromEdit(); //retornar o tamanho de caracteres que contem em characters[?]
	// j = (value - 1);
 ...
 public void updateActiveMessage(int equip) throws Exception {
	...
	// mes = dao.mensagensDisponivelById(messageID);
	 ...
	 else messageUtil.ErrorMessage(localeMessage.getStringKey("dms_activation_message_send_activation_error"), " ");
	 
	
	 } else  messageUtil.WarningMessage(localeMessage.getStringKey("dms_activation_message_activation_not_found"), " "); 
