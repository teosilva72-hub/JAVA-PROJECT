...
public enum ViaRondon {

	LIGHT_VEHICLES("CAT1"),         // Autos (Utiliários, Passeio)
	...
	TRUCK_7AXLES("CAT10"),          // Caminhão 7 Eixos
	TRUCK_8AXLES("CAT11"),          // Caminhão 8 Eixos
	TRUCK_9AXLES("CAT12"),          // Caminhão 9 Eixos
	...
	UNKNOWN_CLASS("Z1");            // Classe desconhecida
			  	 
	private String selectClass; 	 
	 
	    ViaRondon(String classe) {
